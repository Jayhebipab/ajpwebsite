...
<div
  class="absolute hidden group-hover:block 
         text-white pt-6 pb-2 w-48 -mt-5 left-1/2 transform -translate-x-1/2 text-center"
>
  <router-link to="/gallery/artists/Cara-Nicolas" class="block py-2 hover:text-gray-400 transition-all duration-300">Cara Nicolas</router-link>
  <router-link to="/gallery/artists/leo-Botulan" class="block py-2 hover:text-gray-400 transition-all duration-300">Leo Botulan</router-link>
  <router-link to="/gallery/artists/Ivan-Nicolas" class="block py-2 hover:text-gray-400 transition-all duration-300">Ivan Nicolas</router-link>
  <router-link to="/gallery/artists/Jr-Barro" class="block py-2 hover:text-gray-400 transition-all duration-300">JR Barro</router-link>
</div>
