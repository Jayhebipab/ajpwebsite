...
<script>
    function showBookingModal(booking) {
        ...
        modalContent.innerHTML = `
            ...
            <pre class="bg-gray-100 p-3 rounded-lg whitespace-pre-wrap overflow-auto max-h-40">${booking.tattoo_piercing_info}</pre>
        ...
        // Idagdag ang Approve at Cancel buttons sa modal
        const actionsDiv = document.createElement('div');
        actionsDiv.className = 'mt-4 flex justify-end space-x-3';
        actionsDiv.innerHTML = `
            <button class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg transition">Approve</button>
            <button class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg transition">Cancel</button>
        `;
